...
Defines the abstract interface for the three-motor Ackermann drive system.
...
class DriveMode(Enum):
    """Drive mode states for the vehicle."""
...
class AckermannConfig:
    ...
    throttle_deadband: float = 0.01     # Throttle deadband (0-1) - lowered for slow maneuvering
...
class AckermannHAL(ABC):
    ...
    def compute_ackermann_angles(self, steering_angle: float) -> Tuple[float, float]:
        """
